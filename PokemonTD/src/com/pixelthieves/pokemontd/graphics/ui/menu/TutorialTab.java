 ...
 */
class TutorialTab extends ChildTab {

    private final float textBlockHeight;
    private final float textBlockY;
    private String tutorialText =
            "In Pokemon tower defense the goal is to prevent the creeps from reaching the end of the path by building towers and surviving all creep waves. Every time a creep gets through the whole way, you loose life.\n\n" +
