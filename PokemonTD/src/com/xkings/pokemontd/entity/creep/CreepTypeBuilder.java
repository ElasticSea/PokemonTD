...
public class CreepTypeBuilder {
    ...
    public List<CreepTypeSpecification> getData() {
        // životy, goldy, ability, abilitytype
        ...
        list.add(new CreepTypeSpecification(CreepName.Quasgire, 141,Treasure.fromGold(2), CreepAbilityType.NORMAL));
        list.add(new CreepTypeSpecification(CreepName.Espeon, 164,Treasure.fromGold(2), CreepAbilityType.RESURRECT));
        list.add(new CreepTypeSpecification(CreepName.Fortress, 192,Treasure.fromGold(2), CreepAbilityType.NORMAL));
        list.add(new CreepTypeSpecification(CreepName.Snubbul, 225,Treasure.fromGold(2), CreepAbilityType.NORMAL));
        ...
        list.add(new CreepTypeSpecification(CreepName.Feabas, 8546,Treasure.fromGold(19), CreepAbilityType.NORMAL));
        ...
        list.add(new CreepTypeSpecification(CreepName.Giaceon, 50800,Treasure.fromGold(55), CreepAbilityType.NORMAL));
        ...
        list.add(new CreepTypeSpecification(CreepName.Watchdog, 274968,Treasure.fromGold(142), CreepAbilityType.SPAWN));
        ...
        list.add(new CreepTypeSpecification(CreepName.Tirtoug, 570174,Treasure.fromGold(208), CreepAbilityType.NORMAL));
        ...
        list.add(new CreepTypeSpecification(CreepName.Flaaffy,1204626 ,Treasure.fromPure(1), CreepAbilityType.NORMAL));
