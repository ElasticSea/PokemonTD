...
public class TowerTypeBuilder {
    ...
    private List<TowerType> getData(float scale) {
        ...
        specs.add(
                new Specs(TowerName.Scratch, 1, SS, NR, HitAbility.getSplash("bullet", scale, 2), Treasure.fromNone()));
        ...
        //green
        specs.add(new Specs(TowerName.Flower, 4, XSS, SR, HitAbility.getNature(scale, 0.2f, 1, 0.2f),
                Treasure.fromNature(1)));
        specs.add(new Specs(TowerName.Forest, 5, XSS, SR, HitAbility.getNature(scale, 0.3f, 1.2f, 0.3f),
                Treasure.fromNature(2)));
        specs.add(new Specs(TowerName.Nature, 10, XSS, SR, HitAbility.getNature(scale, 0.7f, 2f, 0.5f),
                Treasure.fromNature(3)));
        //yellow
        ...
        specs.add(new Specs(TowerName.Nightmare, 10, NS, XL_RANGE, HitAbility.getTemLifeSteal(scale, 0.3f, 5f),
                Treasure.fromDarkness(3)));
        ;
        /// ######################  TWO ELEMENT
        specs.add(new Specs(TowerName.Noble, 5, 45, BUFF_RANGE, BuffAbility.getSpeed(1.25f, 45),
                Treasure.fromWater(1).addFire(1)));
        specs.add(new Specs(TowerName.Majestic, 7, 45, BUFF_RANGE, BuffAbility.getSpeed(1.5f, 45),
                Treasure.fromWater(2).addFire(2)));
        specs.add(new Specs(TowerName.Magnificent, 9, 45, BUFF_RANGE, BuffAbility.getSpeed(2f, 45),
                Treasure.fromWater(3).addFire(3)));

        specs.add(new Specs(TowerName.Sunny, 5, XSS, L_RANGE, new SunbeamAbility(0.2f, L_RANGE),
                Treasure.fromWater(1).addNature(1)));
        specs.add(new Specs(TowerName.Solar, 7, XSS, L_RANGE, new SunbeamAbility(0.7f, L_RANGE * 1.5f),
                Treasure.fromWater(2).addNature(2)));
        specs.add(new Specs(TowerName.Photonic, 9, XSS, L_RANGE, new SunbeamAbility(1.7f, L_RANGE * 2),
                Treasure.fromWater(3).addNature(3)));

        specs.add(new Specs(TowerName.Poison, 5, NS, NR, HitAbility.getPoison(scale, 0.2f, 1, 0.2f),
                Treasure.fromWater(1).addLight(1)));
        specs.add(new Specs(TowerName.Toxic, 7, NS, NR, HitAbility.getPoison(scale, 0.2f, 1, 0.2f),
                Treasure.fromWater(2).addLight(2)));
        specs.add(new Specs(TowerName.Venom, 9, NS, NR, HitAbility.getPoison(scale, 0.2f, 1, 0.2f),
                Treasure.fromWater(3).addLight(3)));

        specs.add(new Specs(TowerName.Ice, 5, NS, NR, HitAbility.getSlow("ice", scale, 0f, 0.2f, 1, 1f),
                Treasure.fromWater(1).addDarkness(1)));
        specs.add(new Specs(TowerName.Freezing, 7, NS, NR, HitAbility.getSlow("ice", scale, 1f, 0.3f, 1.5f, 1f),
                Treasure.fromWater(2).addDarkness(2)));
        specs.add(new Specs(TowerName.Polar, 9, NS, NR, HitAbility.getSlow("ice", scale, 2f, 0.7f, 2, 1f),
                Treasure.fromWater(3).addDarkness(3)));

        // FIXME MISSING TOWERS (FLAMTHROWER...)
        specs.add(new Specs(TowerName.Sneaky, 5, NS, NR, HitAbility.getMoney(scale, 1.5f),
                Treasure.fromFire(1).addDarkness(1)));
        specs.add(new Specs(TowerName.Stealth, 7, NS, NR, HitAbility.getMoney(scale, 1.75f),
                Treasure.fromFire(2).addDarkness(2)));
        specs.add(new Specs(TowerName.Thief, 9, NS, NR, HitAbility.getMoney(scale, 2f),
                Treasure.fromFire(3).addDarkness(3)));

        specs.add(new Specs(TowerName.Pebble, 5, SS, NR, HitAbility.getSplash("rock", scale, 2),
                Treasure.fromNature(1).addLight(1)));
        specs.add(new Specs(TowerName.Rocky, 7, SS, SR, HitAbility.getSplash("rock", scale, 3),
                Treasure.fromNature(2).addLight(2)));
        specs.add(new Specs(TowerName.Massive, 9, XSS, XSR, HitAbility.getSplash("rock", scale, 5),
                Treasure.fromNature(3).addLight(3)));

        specs.add(new Specs(TowerName.Dizzy, 5, NS, NR, HitAbility.getSlow("orb", scale, 0, 0.5f, 1, 0.5f),
                Treasure.fromNature(1).addDarkness(1)));
        specs.add(new Specs(TowerName.Paralyze, 7, NS, NR, HitAbility.getSlow("orb", scale, 0, 0.7f, 2, 0.75f),
                Treasure.fromNature(2).addDarkness(2)));
        specs.add(new Specs(TowerName.Crippling, 9, NS, NR, HitAbility.getSlow("orb", scale, 0, 0.9f, 4, 0.85f),
                Treasure.fromNature(3).addDarkness(3)));

        specs.add(new Specs(TowerName.Spell, 5, 45, BUFF_RANGE, BuffAbility.getDamage(1.25f, 45),
                Treasure.fromWater(1).addFire(1)));
        specs.add(new Specs(TowerName.Enchanted, 7, 45, BUFF_RANGE, BuffAbility.getDamage(1.5f, 45),
                Treasure.fromWater(2).addFire(2)));
        specs.add(new Specs(TowerName.Magic, 9, 45, BUFF_RANGE, BuffAbility.getDamage(2f, 45),
                Treasure.fromWater(3).addFire(3)));
