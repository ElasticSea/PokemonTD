...
public class TowerEntityInfo extends TowerInfo {
    ...
    public void render(Entity entity) {
        ...
        if (spriteComponent != null && nameComponent != null && rangeComponent != null && damageComponent != null &&
                speedComponent != null) {
            render(spriteComponent.getSprite(), "Dmg: " + (int) damageComponent.getDamage(),
                    "Spd: " + (int) speedComponent.getSpeed(), "Rng: " + (int) rangeComponent.getRange(),
                    costComponent.getTreasure(), nameComponent.getName(), true, false);
        }
