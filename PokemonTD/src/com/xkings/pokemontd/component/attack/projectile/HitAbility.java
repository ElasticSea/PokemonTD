...
public class HitAbility extends EffectData {
    ...
    public static AbilityComponent getNormal(String texture, float scale) {
        return new HitAbility(EffectName.Default, texture, Type.FOLLOW_TARGET, DEFAULT_SIZE * scale,
    ...
    public static AbilityComponent getTemLifeSteal(float scale, float duration) {
        return new HitAbility(EffectName.Default, "bullet", Type.FOLLOW_TARGET, DEFAULT_SIZE * scale,
    ...
    public static AbilityComponent getFireDot(float scale) {
        return new HitAbility(EffectName.Default, "fireAnimation", Type.FOLLOW_TARGET, BIG_SIZE * scale,
    ...
    public static AbilityComponent getNature(float scale, float slowRatio, float duration, float chance) {
        return new HitAbility(EffectName.Default, "leaf", Type.FOLLOW_TARGET, BIG_SIZE * scale, SLOW_SPEED * scale,
    ...
    public static AbilityComponent getClaw(float scale, float chance, int iterations) {
        return new HitAbility(EffectName.Default, "leaf", Type.IMMEDIATE_ATTACK, BIG_SIZE * scale, FAST_SPEED * scale,
    ...
    public static AbilityComponent getPoison(float scale, float slowRatio, float duration, float chance) {
        return new HitAbility(EffectName.Default, "poison", Type.FOLLOW_TARGET, BIG_SIZE * scale, SLOW_SPEED * scale,
    ...
    public static AbilityComponent getSlow(String bulletTexture, String texture, float scale, float range,
        ...
        return new HitAbility(EffectName.Default, bulletTexture, Type.FOLLOW_TARGET, DEFAULT_SIZE * scale,
    ...
    public static AbilityComponent getMoney(float scale, float ratio) {
        return new HitAbility(EffectName.Default, "coinAttack", Type.FOLLOW_TARGET, BIG_SIZE * scale,
                NORMAL_SPEED * scale, new MoneyData("", ratio));
    }

    public static AbilityComponent getLife(float scale, float ratio, float chance) {
        return new HitAbility(EffectName.Default, "hearth", Type.FOLLOW_TARGET, BIG_SIZE * scale, NORMAL_SPEED * scale,
                new LifeData("", ratio, chance));
    }

    public static AbilityComponent getAuraDmg(float scale, float range) {
        return new HitAbility(EffectName.Default, "bullet", Type.IMMEDIATE_NOCONTACT_DAMAGE, BIG_SIZE * scale,
                NORMAL_SPEED * scale, range * scale, new NormalData());
    }
    ...
    public static AbilityComponent getCharge(float scale) {
        return new HitAbility(EffectName.Default, "charge", Type.FOLLOW_TARGET, SUPER_BIG_SIZE * scale,
                FAST_SPEED * scale, new NormalData());
    }

    public static AbilityComponent getChangeDirection(float scale, int duration, float chance) {
        return new HitAbility(EffectName.Default, "hypno", Type.FOLLOW_TARGET, DEFAULT_SIZE * scale, FAST_SPEED * scale,
                new ChangeDirectionData(duration, chance));
    }


    public static AbilityComponent getBubble(String texture, float scale) {
        return new HitAbility(EffectName.Default, texture, Type.PASS_THROUGH, BIG_SIZE * scale, NORMAL_SPEED * scale,
                new BubbleData(0.25f, 1f));
    }

    public static AbilityComponent getBubbleGrowing(float scale) {
        return new HitAbility(EffectName.Default, "bubble", Type.PASS_THROUGH, BIG_SIZE * scale, NORMAL_SPEED * scale,
                new BubbleData(0.25f, 1f));
    }


    public static AbilityComponent getIncreasingDamage(float scale) {
        return new HitAbility(EffectName.Default, "leaf", Type.FOLLOW_TARGET, DEFAULT_SIZE * scale, FAST_SPEED * scale,
    ...
    public HitAbility(EffectName name, String texture, Type type, float size, float speed, EffectData... effectData) {
        this(name, texture, type, size, speed, 0, effectData);
    }

    public HitAbility(EffectName name, String texture, Type type, float size, float speed, float aoe,
